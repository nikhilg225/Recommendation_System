...
public class Popular extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("By-Nikhil Gupta");

        jLabel2.setBackground(new java.awt.Color(0, 153, 153));
        jLabel2.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 27)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 204, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Welcome to Application Recommendation System");
        ...
        jComboBox1.setFont(new java.awt.Font("Gill Sans Ultra Bold", 1, 13)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("Select"!=jComboBox1.getSelectedItem())
        {String cb1;
        cb1=(String)jComboBox1.getSelectedItem();
        Result r=new Result(cb1);
        r.setVisible(true);
